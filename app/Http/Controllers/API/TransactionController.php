...
class TransactionController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return ResponseFormatter::error($e, 'Data transaksi gagal diupdate');
        }
    }
    ...
    {
        $request->validate([
            'food_id' => 'required|exists:food,id', //mengecek id di tabel food
            'user_id' => 'required|exists:users,id', //mengecek id di tabel users
            'quantity' => 'required',
            'total' => 'required',
            'status' => 'required',
        ]);
